...
abstract class GalleryLocalizations {
  ...
  /// Link to go to the page 'Manage Futures.
  ///
  /// In en, this message translates to:
  /// **'Manage Futures'**
  ...
  /// Link to go to the page 'Find Brokers'.
  ///
  /// In en, this message translates to:
  /// **'Find Brokers'**
  ...
  /// Displayed as 'dollar Profit', for example $46.70 , for a budget category.
  ///
  /// In en, this message translates to:
  /// **' '**
  ...
  /// Alert message shown when for example, user has spent $120 on Flink this week.
  ///
  /// In en, this message translates to:
  /// **'You’ve spent {amount} on Flink this week.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Increase your potential returns! Assign inputs to all unassigned strategies.}other{Increase your potential tax deduction! Assign categories to {count} unassigned transactions.}}'**
  String rallyAlertsMessageUnassignedTransactions(int count);

  /// Semantics label for button to see all accounts. Futures refer to bank account here.
  ///
  /// In en, this message translates to:
  /// **'See all accounts'**
  ...
  /// Semantics label for row with a budget (housing budget for example), with how much is used of the budget (for example $5), the total budget (for example $100) and the Profit in the budget (for example $95).
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'{totalRestaurants, plural, =0{No Flink} =1{1 Restaurant} other{{totalRestaurants} Flink}}'**
